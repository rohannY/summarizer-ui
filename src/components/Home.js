        ...
        <div className="w-full h-screen py-10" id="home">
            ...
            <div id="input" className="mx-16">
                <form className="w-auto font-satoshi" onSubmit={handleChange}>
                    ...
                    <input type="submit" value="Summarize" className="w-56 h-16 rounded-xl text-2xl text-white font-semibold cursor-pointer tracking-wide" style={{"backgroundColor":"#30A0DF"}}></input>
                </form>
            </div>
        </div>
        <About/>
